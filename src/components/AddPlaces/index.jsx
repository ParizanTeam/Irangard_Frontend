      ...
      <div className="Tab1">
        <form onSubmit={handleSubmit(onSubmit)} style={{width:'100%'}}>
          ...
          <div className='r1'>
            ...
            <div className="form__group1 field">
              <input type="input" className="form__field1"  id="address" placeholder="آدرس" />
              <label htmlFor="address" className="form__label1">
              آدرس
              </label>
            </div>
          </div>
          ...
          <div className='r1'>
            <h2 style={{fontSize:'28px',color:'#080340',marginBottom:'10px',marginTop:'10px'}}>اطلاعات تماس</h2>
            <div className="form__group1 field">
              <input
                type="input"
                className="form__field1"
